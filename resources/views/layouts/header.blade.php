...
<head>
	<title>Weboccult | @yield('title')</title>
									...
									<div class="menu-item px-3">
										<div class="menu-content d-flex align-items-center px-3">
											...
											<div class="d-flex flex-column">
												<div class="fw-bold d-flex align-items-center fs-5">@isset(auth()->user()->name){{ auth()->user()->name }}@endisset
													<span
														class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Pro</span>
												</div>
												<a href="#"
													class="fw-semibold text-muted text-hover-primary fs-7">@isset(auth()->user()->email){{ auth()->user()->email }}@endisset</a>
											</div>
											<!--end::Username-->
										</div>
									</div>
						...
						<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
							...
							<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
								...
								{{-- <div data-kt-menu-trigger="click" class="menu-item here menu-accordion"> --}}
									<!--begin:Menu link-->
									<a href="" class="menu-link @if(isset($home)&& $home == true) active @endif">
								...
								<!--end:Menu item-->
								<!--begin:Menu item-->
								<div data-kt-menu-trigger="click" class="menu-item menu-accordion @if(isset($role) && $role == true) show @elseif(isset($user) && $user == true) show @endif">
									<!--begin:Menu link-->
									...
									<div class="menu-sub menu-sub-accordion">
										<!--begin:Menu item-->
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1 @if(isset($user)&& $user == true) show @endif">
											<!--begin:Menu link-->
											<span class="menu-link">
											...
											<div class="menu-sub menu-sub-accordion">
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link @if(isset($user)&& $user == true) active @endif" href="{{ route('user.view') }}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
										...
										<!--end:Menu item-->
										<!--begin:Menu item-->
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1 @if(isset($role)&& $role == true) show @endif">
											<!--begin:Menu link-->
											<span class="menu-link">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
								...
								<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion" kt-hidden-height="81" style="">
										...
										<div class="menu-item">
											<!--begin:Menu link-->
											<a class="menu-link" href="{{ route('products.list') }}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												<span class="menu-title">View Prodicts</span>
											</a>
											<!--end:Menu link-->
										</div>
										<!--end:Menu item-->
							...
							<div class="timeline-content mb-10 mt-n1">
								...
								<div class="overflow-auto pb-5">
									<div
										...
										<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
											<!--begin::Icon-->
											<img alt="/../demo1/apps/projects/project.html"
							...
							<div class="row g-5">
								...
								<div class="col-6">
									...
									<div
										...
										<div class="overlay-wrapper">
											<img src="{{ asset('assets/media/preview/demos/demo1/light-ltr.png')}}" alt="demo"
												class="w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="index.html" class="btn btn-sm btn-success shadow">Metronic
												Original</a>
										</div>
									</div>
									<!--end::Demo-->
								...
								<div class="col-6">
									...
									<div
										...
										<div class="overlay-wrapper">
											<img src="{{ asset('assets/media/preview/demos/demo2/light-ltr.png')}}" alt="demo"
												class="w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
								...
								<div class="col-6">
									...
									<div
										class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										<div class="overlay-wrapper">
											<img src="{{ asset('assets/media/preview/demos/demo3/light-ltr.png')}}" alt="demo"
												class="w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo3/index.html"
												class="btn btn-sm btn-success shadow">New Trend</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div
										class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										<div class="overlay-wrapper">
											<img src="{{ asset('assets/media/preview/demos/demo8/light-ltr.png')}}" alt="demo"
												class="w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo8/index.html"
												class="btn btn-sm btn-success shadow">Analytics App</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div
										class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										<div class="overlay-wrapper">
											<img src="{{ asset('assets/media/preview/demos/demo10/light-ltr.png')}}" alt="demo"
												class="w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com0/index.html"
												class="btn btn-sm btn-success shadow">Project Grid</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div
										class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										<div class="overlay-wrapper">
											<img src="{{ asset('assets/media/preview/demos/demo11/light-ltr.png')}}" alt="demo"
												class="w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com1/index.html"
												class="btn btn-sm btn-success shadow">Finance Planner</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div
										class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										<div class="overlay-wrapper">
											<img src="{{ asset('assets/media/preview/demos/demo4/light-ltr.png')}}" alt="demo"
												class="w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
								...
								<div class="col-6">
									...
									<div
										class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										<div class="overlay-wrapper">
											<img src="{{ asset('assets/media/preview/demos/demo27/light-ltr.png')}}" alt="demo"
												class="w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo27/index.html"
												class="btn btn-sm btn-success shadow">Databox Dashboard</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div
										class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										<div class="overlay-wrapper">
											<img src="{{ asset('assets/media/preview/demos/demo20/light-ltr.png')}}" alt="demo"
												class="w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo20/index.html"
												class="btn btn-sm btn-success shadow">CRM Software</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div
										class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										<div class="overlay-wrapper">
											<img src="{{ asset('assets/media/preview/demos/demo25/light-ltr.png')}}" alt="demo"
												class="w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo25/index.html"
												class="btn btn-sm btn-success shadow">User Guiding App</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div
										class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										<div class="overlay-wrapper">
											<img src="{{ asset('assets/media/preview/demos/demo30/light-ltr.png')}}" alt="demo"
												class="w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo30/index.html"
												class="btn btn-sm btn-success shadow">Sales Tracking App</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div
										class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										<div class="overlay-wrapper">
											<img src="{{ asset('assets/media/preview/demos/demo23/light-ltr.png')}}" alt="demo"
												class="w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo23/index.html"
												class="btn btn-sm btn-success shadow">Member Dashboard</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div
										class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										<div class="overlay-wrapper">
											<img src="{{ asset('assets/media/preview/demos/demo29/light-ltr.png')}}" alt="demo"
												class="w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo29/index.html"
												class="btn btn-sm btn-success shadow">Project Workspace</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div
										class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										<div class="overlay-wrapper">
											<img src="{{ asset('assets/media/preview/demos/demo14/light-ltr.png')}}" alt="demo"
												class="w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com4/index.html"
												class="btn btn-sm btn-success shadow">Project Workplace</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div
										class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										<div class="overlay-wrapper">
											<img src="{{ asset('assets/media/preview/demos/demo24/light-ltr.png')}}" alt="demo"
												class="w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo24/index.html"
												class="btn btn-sm btn-success shadow">Helpdesk App</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div
										class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										<div class="overlay-wrapper">
											<img src="{{ asset('assets/media/preview/demos/demo26/light-ltr.png')}}" alt="demo"
												class="w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo26/index.html"
												class="btn btn-sm btn-success shadow">Planable App</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div
										class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										<div class="overlay-wrapper">
											<img src="{{ asset('assets/media/preview/demos/demo7/light-ltr.png')}}" alt="demo"
												class="w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo7/index.html"
												class="btn btn-sm btn-success shadow">CRM Dashboard</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div
										class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										<div class="overlay-wrapper">
											<img src="{{ asset('assets/media/preview/demos/demo22/light-ltr.png')}}" alt="demo"
												class="w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
								...
								<div class="col-6">
									...
									<div
										class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										<div class="overlay-wrapper">
											<img src="{{ asset('assets/media/preview/demos/demo28/light-ltr.png')}}" alt="demo"
												class="w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo28/index.html"
												class="btn btn-sm btn-success shadow">eCommerce App</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div
										class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										<div class="overlay-wrapper">
											<img src="{{ asset('assets/media/preview/demos/demo19/light-ltr.png')}}" alt="demo"
												class="w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com9/index.html"
												class="btn btn-sm btn-success shadow">Reports Panel</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div
										class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										<div class="overlay-wrapper">
											<img src="{{ asset('assets/media/preview/demos/demo9/light-ltr.png')}}" alt="demo"
												class="w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo9/index.html"
												class="btn btn-sm btn-success shadow">Sales Manager</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div
										class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										<div class="overlay-wrapper">
											<img src="{{ asset('assets/media/preview/demos/demo13/light-ltr.png')}}" alt="demo"
												class="w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com3/index.html"
												class="btn btn-sm btn-success shadow">Classic Dashboard</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div
										class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										<div class="overlay-wrapper">
											<img src="{{ asset('assets/media/preview/demos/demo16/light-ltr.png')}}" alt="demo"
												class="w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com6/index.html"
												class="btn btn-sm btn-success shadow">Podcast App</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div
										class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										<div class="overlay-wrapper">
											<img src="{{ asset('assets/media/preview/demos/demo18/light-ltr.png')}}" alt="demo"
												class="w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com8/index.html"
								...
								<div class="col-6">
									...
									<div
										class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										<div class="overlay-wrapper">
											<img src="{{ asset('assets/media/preview/demos/demo21/light-ltr.png')}}" alt="demo"
												class="w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo21/index.html"
												class="btn btn-sm btn-success shadow">Monochrome App</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div
										class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										<div class="overlay-wrapper">
											<img src="{{ asset('assets/media/preview/demos/demo12/light-ltr.png')}}" alt="demo"
												class="w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com2/index.html"
								...
								<div class="col-6">
									...
									<div
										class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										<div class="overlay-wrapper">
											<img src="{{ asset('assets/media/preview/demos/demo17/light-ltr.png')}}" alt="demo"
												class="w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com7/index.html"
												class="btn btn-sm btn-success shadow">Events Scheduler</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div
										class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										<div class="overlay-wrapper">
											<img src="{{ asset('assets/media/preview/demos/demo15/light-ltr.png')}}" alt="demo"
												class="w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com5/index.html"
												class="btn btn-sm btn-success shadow">Crypto Planner</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
								...
								<div class="col-6">
									...
									<div
										class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										<div class="overlay-wrapper">
											<img src="{{ asset('assets/media/preview/demos/demo5/light-ltr.png')}}" alt="demo"
												class="w-100" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
											<a href="https://preview.keenthemes.com/metronic8/demo5/index.html"
												class="btn btn-sm btn-success shadow">Support Forum</a>
										</div>
									</div>
									<!--end::Demo-->
								</div>
