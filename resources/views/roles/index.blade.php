                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card card-flush h-md-100">
                                ...
                                <div class="card-body pt-1">
                                    <!--begin::Users-->
                                    <div class="fw-bold text-gray-600 mb-5">Total users with this role: {{ count($role['users']) }}
                                    </div>
                                    <!--end::Users-->
                                ...
                                <div class="card-footer flex-wrap pt-0">
                                    <a href="{{ route('role.view',encrypt($role['id'])) }}"
                            ...
                            <form id="kt_modal_add_role_form" class="form" action="#">
                                ...
                                <div class="text-center pt-15">
                                    <button type="reset" class="btn btn-light me-3"
                                        data-kt-roles-modal-action="cancel" id="kt_modal_add_customer_cancel">
                                        Discard
                                    </button>
